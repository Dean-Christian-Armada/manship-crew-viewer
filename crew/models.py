...
class Principal(models.Model):
    ...
    principal = models.CharField(db_column='P_KEY', primary_key=True, max_length=6)  # Field name made lowercase.
...
class Rank(models.Model):
    ...
    rank = models.CharField(db_column='R_KEY', primary_key=True, max_length=4)  # Field name made lowercase.
...
class Vessel(models.Model):
    ...
    vessel = models.CharField(db_column='V_KEY', primary_key=True, max_length=4)  # Field name made lowercase.
    vessel_type = models.ForeignKey('Vtype', db_column='V_Type')  # Field name made lowercase.
    v_full = models.CharField(db_column='V_Full', max_length=32, blank=True, null=True)  # Field name made lowercase.
    principal = models.CharField(db_column='V_P_KEY', max_length=6, blank=True, null=True)  # Field name made lowercase.
...
class Vtype(models.Model):
    ...
    vessel_type = models.CharField(db_column='VT_KEY', primary_key=True, max_length=4)  # Field name made lowercase.
...
class Bio(models.Model):
	...
	code = models.CharField(db_column='B_ID', max_length=4, primary_key=True)  # Field name made lowercase.
	...
	last_name = models.CharField(db_column='B_Last_Name', max_length=18, blank=True, null=True)  # Field name made lowercase.
	b_last_name_grk = models.CharField(db_column='B_Last_Name_Grk', max_length=18, blank=True, null=True)  # Field name made lowercase.
	first_name = models.CharField(db_column='B_First_Name', max_length=28, blank=True, null=True)  # Field name made lowercase.
	...
	middle_name = models.CharField(db_column='B_Middle_Name', max_length=18, blank=True, null=True)  # Field name made lowercase.
	...
	country = models.CharField(db_column='B_CN_KEY', max_length=2, blank=True, null=True)  # Field name made lowercase.
	status = models.CharField(db_column='B_Bio_Status', max_length=1, blank=True, null=True)  # Field name made lowercase.
	b_available = models.DateField(db_column='B_Available', blank=True, null=True)  # Field name made lowercase.
	rank = models.CharField(db_column='B_Position_1st', max_length=4, blank=True, null=True)  # Field name made lowercase.
	b_ex_crew = models.CharField(db_column='B_Ex_Crew', max_length=1, blank=True, null=True)  # Field name made lowercase.
	last_vessel = models.ForeignKey('Vessel', db_column='B_Last_V_KEY')  # Field name made lowercase.
	...
	def view_info(self):
		return mark_safe("<button type='button' >View Full Info</button>")

	# def view_info(self):
	# 	return mark_safe("<a href='/' class='btn btn-warning view-info' onclick='return showAddAnotherPopup(this);'><button type='button'>View Full Info</button></a>")

	def view_picture(self):
		return mark_safe("<button type='button' class='btn btn-warning view-pic'>View Picture</button>")
