...
function showRelatedObjectPopup(triggeringLink, widthpercentage, heightpercentage) {
    ...
    h=h*heightpercentage;
    t=h*0.15;

    var name = triggeringLink.id.replace(/^(change|add|delete)_/, '');
    name = id_to_windowname(name);
    var href = triggeringLink.href;   
    setTimeout(function(){ win = window.open(href, name, 'height='+h+',width='+w+',left='+l+',top='+t+',resizable=yes,scrollbars=yes'); win.focus(); }, 1);      
    return false;
}
